  ...
  return (
    <PageTransition>
      <SEO
        ...
        description="M.I. Engineering Works manufactures fasteners to the highest international standards — ASTM A193, ANSI/ASME B16.5, DIN 976, ISO 4014, BS, IS, SAE, EN, UNI."
        keywords={["ASTM A193 B7 standard", "DIN 976 threaded rods standard", "ISO 4014 hex bolts standard", "ANSI ASME B16.5 stud bolts", "fastener standards India"]}
        path="/standards"
      />
              ...
              >
                {s.image && (
                  <div className="aspect-[16/9] overflow-hidden bg-secondary">
                    <img src={resolveImage("standard", s.slug, s.image)} alt={s.code} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy" />
                  </div>
                )}
