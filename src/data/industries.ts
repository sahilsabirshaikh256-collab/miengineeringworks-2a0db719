...
export const industries: Industry[] = [
  {
    ...
    applications: [
      { name: "Wellhead & Christmas Tree Assemblies", description: "B7 stud bolts secure wellhead flanges at pressures exceeding 15,000 PSI", image: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&q=80" },
      { name: "Pipeline Flange Connections", description: "ASME B16.5 flanges bolted with B7 studs from 1/2\" to 24\" NB", image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=400&q=80" },
      { name: "Refinery Process Units", description: "High-temperature B16 bolts in FCC units, hydrocrackers, and distillation columns", image: "https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=400&q=80" },
      { name: "Offshore Platforms", description: "Hot-dip galvanized B7 fasteners with PTFE coating for marine environments", image: "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=400&q=80" },
    ],
  ...
  },
  {
    ...
    applications: [
      { name: "Heat Exchangers", description: "B7 stud bolts for shell-and-tube exchanger flanges up to 30\" diameter", image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&q=80" },
      { name: "Pressure Vessels", description: "B7/B16 bolting for ASME Section VIII vessels operating at 300+ PSI", image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=400&q=80" },
      { name: "Distillation Columns", description: "High-temperature B16 fasteners for tray and packing column flanges", image: "https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=400&q=80" },
      { name: "Piping Systems", description: "Full range of B7 studs for ASME B16.5 and B16.47 flanged joints", image: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&q=80" },
    ],
  ...
  },
  {
    ...
    applications: [
      { name: "Steam Turbines", description: "B16 stud bolts for turbine casing joints operating at 540°C/3500 PSI", image: "https://images.unsplash.com/photo-1548346941-89752a3f3b88?w=400&q=80" },
      { name: "Boiler Systems", description: "B7 hex bolts for boiler drum manways, header connections", image: "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=400&q=80" },
      { name: "Gas Turbine Enclosures", description: "High-temperature B16 fasteners for combustion chamber flanges", image: "https://images.unsplash.com/photo-1532601224476-15c79f2f7a51?w=400&q=80" },
      { name: "Wind Turbine Foundations", description: "F1554 Grade 105 anchor bolts for turbine base foundations", image: "https://images.unsplash.com/photo-1532601224476-15c79f2f7a51?w=400&q=80" },
    ],
  ...
  },
  {
    ...
    applications: [
      { name: "Steel Structure Erection", description: "High-strength hex bolts for moment connections and bracing", image: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=400&q=80" },
      { name: "Bridge Construction", description: "Grade 10.9 bolts for girder splices, bearing assemblies", image: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=400&q=80" },
      { name: "Foundation Anchoring", description: "F1554 anchor bolts embedded in concrete for column bases", image: "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=400&q=80" },
      { name: "Pre-Engineered Buildings", description: "B7 threaded rods and U-bolts for purlins and cladding systems", image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=400&q=80" },
    ],
  ...
  },
  {
    ...
    applications: [
      { name: "Ship Engine Rooms", description: "B7 PTFE-coated stud bolts for main engine flanges and auxiliaries", image: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400&q=80" },
      { name: "Offshore Platforms", description: "Duplex and super duplex fasteners for subsea structures", image: "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=400&q=80" },
      { name: "Port Infrastructure", description: "HDG anchor bolts for quay walls, cranes, and dock equipment", image: "https://images.unsplash.com/photo-1494412574643-ff11b0a5eb19?w=400&q=80" },
      { name: "Naval Vessels", description: "MIL-SPEC fasteners for defense and naval vessel construction", image: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400&q=80" },
    ],
  ...
  },
  {
    ...
    applications: [
      { name: "Filtration Systems", description: "B8M stud bolts for filter vessel flanges handling chlorinated water", image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&q=80" },
      { name: "Chemical Dosing Units", description: "SS 316 fasteners resistant to sodium hypochlorite and caustic soda", image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=400&q=80" },
      { name: "Pumping Stations", description: "B7 hex bolts and anchor bolts for pump bases and pipe supports", image: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&q=80" },
      { name: "Desalination Plants", description: "Super duplex fasteners for high-salinity RO systems", image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&q=80" },
    ],
  ...
  },
  {
    ...
    applications: [
      { name: "Crushers & Screens", description: "Grade 12.9 socket head cap screws for jaw and cone crusher assemblies", image: "https://images.unsplash.com/photo-1578319439584-104c94d37305?w=400&q=80" },
      { name: "Conveyor Systems", description: "B7 hex bolts and U-bolts for belt conveyor frames and idler brackets", image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=400&q=80" },
      { name: "Processing Mills", description: "Heavy hex bolts for SAG and ball mill flanges, trunnion bearing bolts", image: "https://images.unsplash.com/photo-1578319439584-104c94d37305?w=400&q=80" },
      { name: "Material Handling", description: "Anchor bolts and threaded rods for hopper, chute, and bin mounting", image: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=400&q=80" },
    ],
  ...
  },
  {
    ...
    applications: [
      { name: "Engine Assembly", description: "Grade 10.9/12.9 bolts for cylinder head, manifold, and timing cover", image: "https://images.unsplash.com/photo-1565043666747-69f6646db940?w=400&q=80" },
      { name: "Die & Mold Making", description: "B7 socket head cap screws for die clamping and mold retention", image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&q=80" },
      { name: "Production Machinery", description: "B7 hex bolts for CNC machines, hydraulic presses, and lathes", image: "https://images.unsplash.com/photo-1565043666747-69f6646db940?w=400&q=80" },
      { name: "Assembly Lines", description: "Precision socket screws and set screws for automated assembly jigs", image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=400&q=80" },
    ],
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1532187863486-abf4dbce1b86?w=600&q=80",
    grades: [
    ...
    applications: [
      { name: "Reactor Vessels", description: "Exotic alloy bolting for reactor flanges handling corrosive chemicals", image: "https://images.unsplash.com/photo-1532187863486-abf4dbce1b86?w=400&q=80" },
      { name: "Acid Storage Tanks", description: "B8M and Hastelloy fasteners for concentrated acid tank nozzles", image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=400&q=80" },
      { name: "Piping & Valves", description: "Duplex stud bolts for chloride-resistant piping systems", image: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&q=80" },
      { name: "Scrubber Systems", description: "Inconel 625 bolts for wet FGD scrubbers and gas cleaning systems", image: "https://images.unsplash.com/photo-1532187863486-abf4dbce1b86?w=400&q=80" },
    ],
  ...
  },
  {
    ...
    applications: [
      { name: "Dairy Processing", description: "SS 316 tri-clamp bolts and hex bolts for milk processing lines", image: "https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=400&q=80" },
      { name: "Pharmaceutical Vessels", description: "Electropolished B8M stud bolts for reactor and mixer flanges", image: "https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=400&q=80" },
      { name: "Brewing & Beverage", description: "A4-80 hex bolts for fermentation tanks and bottling equipment", image: "https://images.unsplash.com/photo-1532187863486-abf4dbce1b86?w=400&q=80" },
      { name: "Packaging Lines", description: "SS 304 socket screws for hygienic conveyor and filling machines", image: "https://images.unsplash.com/photo-1565043666747-69f6646db940?w=400&q=80" },
    ],
  ...
  },
  {
    ...
    applications: [
      { name: "Aircraft Assembly", description: "Titanium and Inconel fasteners for airframe and engine mounting", image: "https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=400&q=80" },
      { name: "Defense Equipment", description: "MIL-SPEC B7 bolts for armored vehicles, artillery, and naval systems", image: "https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=400&q=80" },
      { name: "Space Launch Systems", description: "A286 superalloy bolts for rocket engine flanges and structural joints", image: "https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=400&q=80" },
      { name: "Ground Support Equipment", description: "B7 anchor bolts and threaded rods for launch pad infrastructure", image: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=400&q=80" },
    ],
  ...
  },
  {
    ...
    applications: [
      { name: "Track Infrastructure", description: "High-tensile fishplate bolts and rail clips for permanent way", image: "https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=400&q=80" },
      { name: "Bridges & Viaducts", description: "B7 stud bolts for rail bridge bearings and expansion joints", image: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=400&q=80" },
      { name: "Rolling Stock", description: "Grade 10.9 bolts for bogie assemblies, brake systems, couplings", image: "https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=400&q=80" },
      { name: "Station Infrastructure", description: "Anchor bolts and threaded rods for platform canopies and structures", image: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=400&q=80" },
    ],
